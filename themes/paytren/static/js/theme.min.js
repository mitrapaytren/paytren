...
var greedly=function(e){"use strict";return{init:function(){e(".post-loop").owlCarousel({loop:!0,dots:!1,nav:!0,navSpeed:500,navClass:["button-slider button-prev","button-slider button-next"],navText:["<i class='icon-angle-left'></i>","<i class='icon-angle-right'></i>"],autoPlay:3e3,items:1}),e(".book-carousel").owlCarousel({loop:!0,nav:!0,dots:!1,margin:30,navSpeed:500,navClass:["nav-slider nav-prev","nav-slider nav-next"],navText:["<i class='icon-angle-left'></i>","<i class='icon-angle-right'></i>"],autoPlay:3e3,responsiveClass:!0,responsive:{0:{items:1},600:{items:2},900:{items:3}}}),e(".tren-slider").owlCarousel({loop:!0,center:!0,nav:!0,dots:!1,margin:30,navSpeed:500,navClass:["nav-slider nav-prev","nav-slider nav-next"],navText:["<i class='icon-angle-left'></i>","<i class='icon-angle-right'></i>"],autoPlay:3e3,responsiveClass:!0,items:1}),e(".nav-toggle").on("click",function(){e(".nav-menu").toggleClass("nav-menu-active")}),e(".nav-toggle").on("click",function(){this.classList.toggle("active")}),function(){var e,n=document.getElementsByClassName("qa-button");for(e=0;e<n.length;e++)n[e].onclick=function(){this.classList.toggle("active");var e=this.nextElementSibling;e.style.maxHeight?e.style.maxHeight=null:e.style.maxHeight=e.scrollHeight+"px"}}(),function(){if(""!==config.disqus_shortname&&null!==config.disqus_shortname&&void 0!==config.disqus_shortname){var e=config.disqus_shortname;!function(){var n=document,t=n.createElement("script");t.src="https://"+e+".disqus.com/embed.js",t.setAttribute("data-timestamp",+new Date),(n.head||n.body).appendChild(t)}(),function(){var n=document.createElement("script");n.id="dsq-count-scr",n.async=!0,n.src="//"+e+".disqus.com/count.js",document.getElementsByTagName("body")[0].appendChild(n)}()}}(),function(){if(""!==config.instagram_userId&&null!==config.instagram_userId&&void 0!==config.instagram_userId){var n=config.instagram_userId,t=config.instagram_accessToken;new Instafeed({get:"user",limit:12,userId:n,accessToken:t,after:function(){e(".owl-carousel").owlCarousel({items:6,loop:!0,dots:!1,autoplay:!0,autoplayTimeout:2e3,autoplayHoverPause:!0})},template:' <div class="instafeed"><a class="animation" href="{{link}}"><div class="instafeed-img" style="background-image: url({{image}})"></div></a></div>'}).run()}}(),e(".treni-video, .tren-youtube").fitVids(),hljs.initHighlightingOnLoad()}}}(jQuery);!function(){"use strict";greedly.init()}();